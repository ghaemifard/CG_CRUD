...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/edu/islab/acceleo/insert/common/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(insert.InsertPackage.class)) {
            resourceSet.getPackageRegistry().put(insert.InsertPackage.eINSTANCE.getNsURI(), insert.InsertPackage.eINSTANCE);
        }
