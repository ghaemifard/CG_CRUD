...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/edu/islab/acceleo/update/common/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(update.UpdatePackage.class)) {
            resourceSet.getPackageRegistry().put(update.UpdatePackage.eINSTANCE.getNsURI(), update.UpdatePackage.eINSTANCE);
        }
